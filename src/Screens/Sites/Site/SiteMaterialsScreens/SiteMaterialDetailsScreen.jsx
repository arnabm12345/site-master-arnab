...
const SiteMaterialDetailsScreen = ({ navigation }) => {
  return (
    <SafeAreaView>
      <View className="px-8 py-6">
        ...
        <View className="mt-4 flex flex-row justify-between">
          ...
          <TouchableOpacity onPress={()=>{navigation.navigate("SiteMaterialStack", { screen: "Deliveries" })}}>
        ...
        <View className="mt-3 flex flex-row items-center justify-between">
          ...
          <View className="h-24 w-64 bg-purple-100 rounded-lg items-center flex flex-column justify-evenly">
            <Text className="text-xs font-medium">No Upcoming Deliveries</Text>

            <TouchableOpacity
              className="w-5/12 h-2/5 rounded-t-lg rounded-b-lg flex flex-row items-center justify-evenly"
              onPress={() => navigation.navigate( "SiteMaterialStack", { screen: "SiteMaterialScreenWithInformation" })}
              style={{ backgroundColor: "rgba(214, 184, 233, 1)" } }
            >
              <Text className="text-xs font-medium">Add Delivery</Text>
        ...
        <View className="flex flex-row justify-between mt-7">
          ...
          <MaterialIcons name="inventory" size={22} color="black" />
        ...
        <View className="mt-3 flex flex-row justify-between h-10">
          ...
          onPress={() => navigation.navigate("SiteMaterialStack", { screen: "AddMaterial1" })}>
...
export default SiteMaterialDetailsScreen;
